...
*/
bddfilehandler masterbdd::bdd_file_hook(bddfilehandler handler)
{
...
void masterbdd::bdd_fprintall(FILE* ofile) *}
...
*/
void masterbdd::bdd_printall(void)
{
...
void masterbdd::bdd_fprinttable(FILE* ofile, BDD r) *}
...
*/
void masterbdd::bdd_printtable(BDD r)
{
...
*/
void masterbdd::bdd_printset(BDD r)
{
   bdd_fprintset(stdout, r);
}


void masterbdd::bdd_fprintset(FILE *ofile, BDD r)
{
   int *set;
...
void masterbdd::bdd_printset_rec(FILE *ofile, int r, int *set)
{
   int n;
   int first;
...
int masterbdd::bdd_fnprintdot(char* fname, BDD r)
void masterbdd::bdd_fprintdot(FILE* ofile, BDD r) *}
...
*/
void masterbdd::bdd_printdot(BDD r)
{
...
void masterbdd::bdd_fprintdot_rec(FILE* ofile, BDD r)
{
...
int masterbdd::bdd_save(FILE *ofile, BDD r) *}
...
*/
int masterbdd::bdd_fnsave(char *fname, BDD r)
{
   FILE *ofile;
   int ok;
...
int masterbdd::bdd_save_rec(FILE *ofile, int root)
{
...
int masterbdd::bdd_load(FILE *ifile, BDD *r) *}
...
RETURN  {* Zero on succes, otherwise an error code from {\tt bdd.h}. *}
*/
int masterbdd::bdd_fnload(char *fname, BDD *root)
{
   FILE *ifile;
   int ok;
...
int masterbdd::bdd_load(FILE *ifile, BDD *root)
{
   int n, vnum, tmproot;
...
int masterbdd::bdd_loaddata(FILE *ifile)
{
...
void masterbdd::loadhash_add(int key, int data)
{
...
int masterbdd::loadhash_get(int key) const
{
