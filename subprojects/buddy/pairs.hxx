...
void masterbdd::bdd_pairs_init(void)
{
   pairsid = 0;
   pairs = NULL;
}
...
void masterbdd::bdd_pairs_done(void)
{
   bddPair *p = pairs;
   int n;
...
int masterbdd::update_pairsid(void)
{
   pairsid++;
...
void masterbdd::bdd_register_pair(bddPair *p)
{
   p->next = pairs;
   pairs = p;
}
...
void masterbdd::bdd_pairs_vardown(int level)
{
   bddPair *p;
...
bddPair *masterbdd::bdd_pairalloc(void)
{
   bddPair *p;
...
int masterbdd::bdd_pairs_resize(int oldsize, int newsize)
{
   bddPair *p;
   int n;
...
*/
bddPair *masterbdd::bdd_newpair(void)
{
   int n;
   bddPair *p;
...
*/
bddPair *masterbdd::bdd_copypair(bddPair *from)
{
   int n;
   bddPair *p;
...
ALSO    {* bdd\_newpair, bdd\_freepair, bdd\_replace, bdd\_setpair, bdd\_setpairs *}
*/
bddPair *masterbdd::bdd_mergepairs(bddPair *left, bddPair *right)
{
   int n;
   bddPair *p;
...
int masterbdd::bdd_setbddpair(bddPair *pair, int oldvar, BDD newvar) *}
...
*/
int masterbdd::bdd_setpair(bddPair *pair, int oldvar, int newvar)
{
   if (pair == NULL)
      return 0;
...
int masterbdd::bdd_setbddpairs(bddPair *pair, int *oldvar, BDD *newvar, int size) *}
...
*/
int masterbdd::bdd_setpairs(bddPair *pair, int *oldvar, int *newvar, int size)
{
   int n,e;
   if (pair == NULL)
      return 0;
...
*/
void masterbdd::bdd_freepair(bddPair *p)
{
   int n;
...
*/
void masterbdd::bdd_resetpair(bddPair *p)
{
   int n;
