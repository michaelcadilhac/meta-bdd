...
bvec masterbdd::bvec_build(int bitnum, int isTrue)
{
   bvec vec;
   int n;
...
ALSO    {* bvec\_con *}
*/
bvec masterbdd::bvec_copy(bvec src)
{
   bvec dst;
   int n;
...
*/
bvec masterbdd::bvec_true(int bitnum)
{
...
*/
bvec masterbdd::bvec_false(int bitnum)
{
...
*/
bvec masterbdd::bvec_con(int bitnum, int val)
{
...
*/
bvec masterbdd::bvec_var(int bitnum, int offset, int step)
{
   bvec v;
   int n;
...
ALSO    {* bvec\_var *}
*/
bvec masterbdd::bvec_varfdd(int var)
{
   bvec v;
...
ALSO    {* bvec\_var *}
*/
bvec masterbdd::bvec_varvec(int bitnum, int *var)
{
   bvec v;
   int n;
...
*/
bvec masterbdd::bvec_coerce(int bitnum, bvec v)
{
...
*/
int masterbdd::bvec_isconst(bvec e)
{
   int n;
...
DESCR   {* Use this function to release any unused boolean vectors. The
	   ...
	   by {\tt bvec\_free}. *}
*/
void masterbdd::bvec_free(bvec v)
{
   bvec_delref(v);
   free(v.bitvec);
}
...
ALSO    {* bvec\_delref *}
*/
bvec masterbdd::bvec_addref(bvec v)
{
   int n;
...
ALSO    {* bvec\_addref *}
*/
bvec masterbdd::bvec_delref(bvec v)
{
   int n;
...
*/
bvec masterbdd::bvec_map1(bvec a, BDD (*fun)(BDD))
{
   bvec res;
   int n;
...
*/
bvec masterbdd::bvec_map2(bvec a, bvec b, BDD (*fun)(BDD,BDD))
{
   bvec res;
   int n;
...
*/
bvec masterbdd::bvec_map3(bvec a, bvec b, bvec c, BDD (*fun)(BDD,BDD,BDD))
{
   bvec res;
   int n;
...
*/
bvec masterbdd::bvec_add(bvec l, bvec r)
{
   bvec res;
   BDD c = bddfalse;
   int n;
...
*/
bvec masterbdd::bvec_sub(bvec l, bvec r)
{
   bvec res;
   BDD c = bddfalse;
   int n;
...
*/
bvec masterbdd::bvec_mulfixed(bvec e, int c)
{
   bvec res, next, rest;
   int n;
...
*/
bvec masterbdd::bvec_mul(bvec left, bvec right)
{
   int n;
...
void masterbdd::bvec_div_rec(bvec divisor, bvec *remainder, bvec *result, int step)
{
   int n;
...
*/
int masterbdd::bvec_divfixed(bvec e, int c, bvec *res, bvec *rem)
{
   if (c > 0)
   {
...
*/
int masterbdd::bvec_div(bvec left, bvec right, bvec *result, bvec *remainder)
{
   int n, m;
   int bitnum = left.bitnum + right.bitnum;
   bvec res;
...
ALSO    {* bdd\_ite *}
*/
bvec masterbdd::bvec_ite(BDD a, BVEC b, BVEC c)
{
  bvec res;
  int n;
...
*/
bvec masterbdd::bvec_shlfixed(bvec e, int pos, BDD c)
{
   bvec res;
...
*/
BVEC masterbdd::bvec_shl(BVEC l, BVEC r, BDD c)
{
   BVEC res, val;
   BDD tmp1, tmp2, rEquN;
   int n, m;
...
*/
bvec masterbdd::bvec_shrfixed(bvec e, int pos, BDD c)
{
   bvec res;
...
*/
BVEC masterbdd::bvec_shr(BVEC l, BVEC r, BDD c)
{
   BVEC res, val;
   BDD tmp1, tmp2, rEquN;
   int n, m;
...
*/
BDD masterbdd::bvec_lth(bvec l, bvec r)
{
   BDD p = bddfalse;
   int n;
...
*/
BDD masterbdd::bvec_lte(bvec l, bvec r)
{
   BDD p = bddtrue;
   int n;
...
*/
BDD masterbdd::bvec_gth(bvec l, bvec r)
{
...
*/
BDD masterbdd::bvec_gte(bvec l, bvec r)
{
...
*/
BDD masterbdd::bvec_equ(bvec l, bvec r)
{
   BDD p = bddtrue;
   int n;
...
*/
BDD masterbdd::bvec_neq(bvec l, bvec r)
{
